...
NSString * const kCTMediatorParamsKeySwiftTargetModuleName = @"kHLMediatorParamsKeySwiftTargetModuleName";

@interface HLMediator ()

@property (nonatomic, strong) NSMutableDictionary *cachedTarget;

@end

@implementation HLMediator

#pragma mark - public methods
+ (instancetype)sharedInstance
{
    static HLMediator *mediator;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mediator = [[HLMediator alloc] init];
    });
    return mediator;
}
